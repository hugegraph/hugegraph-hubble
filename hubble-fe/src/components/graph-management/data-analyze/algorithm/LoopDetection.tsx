...
const LoopDetection = observer(() => {
  ...
  const isValidExec = !Object.values(algorithmAnalyzerStore.loopDetectionParams).some((value) => value === '');
      ...
      <div className="query-tab-content-form-row">
        ...
        <div className="query-tab-content-form-item">
          <div className="query-tab-content-form-item-title">
            <span>
              {t(
                'data-analyze.algorithm-forms.loop-detection.options.max_capacity'
              )}
            </span>
          </div>
          <Input
            ...
            value={algorithmAnalyzerStore.loopDetectionParams.max_capacity}
            onChange={(e: any) => {
              algorithmAnalyzerStore.mutateLoopDetectionParams(
                'max_capacity',
                e.value as string
      ...
      <div className="query-tab-content-form-row">
        <div className="query-tab-content-form-item">
          <div className="query-tab-content-form-item-title">
            ...
            <span>
              {t(
                'data-analyze.algorithm-forms.loop-detection.options.has_source'
              )}
            </span>
          </div>
          <Switch
            ...
            size="medium"
            disabled={dataAnalyzeStore.requestStatus.fetchGraphs === 'pending'}
            checked={algorithmAnalyzerStore.loopDetectionParams.has_source === '1'}
            onChange={(checked: boolean) => {
              ...
              algorithmAnalyzerStore.validateLoopDetectionParams('has_source');
            }}
          />
        </div>
        <div className="query-tab-content-form-item">

...
const FocusDetection = observer(() => {
  ...
  const isValidExec = !Object.values(algorithmAnalyzerStore.focusDetectionParams).some((value) => value === '');
      ...
      <div className="query-tab-content-form-item">
        ...
        <div className="query-tab-content-form-item">
          <div className="query-tab-content-form-item-title">
            <span>
              {t(
                'data-analyze.algorithm-forms.focus-detection.options.max_capacity'
              )}
            </span>
          </div>
          <Input
